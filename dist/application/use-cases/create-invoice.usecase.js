...
let CreateInvoiceUseCase = class CreateInvoiceUseCase {
    ...
    async execute(dto) {
        const newInvoice = new Invoice_1.Invoice('inv-' + Math.floor(Math.random() * 1000000), dto.amount, 'Pending', dto.studentId, new Date(dto.dueDate), dto.description);
...
//# sourceMappingURL=create-invoice.usecase.js.map